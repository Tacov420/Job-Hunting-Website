					...
					<div className="p-6 space-y-4 md:space-y-6 sm:p-8">
						...
						<div className="space-y-4 md:space-y-6">
							<div>
								...
								<input name="username" 
									className="bg-gray-200 text-gray-900 lg:text-lg rounded-lg w-full p-1.5" id="username"
									ref = {usernameRef}
								/>
							</div>
							<div>
								...
								<input type="password" 
									className="bg-gray-200 text-gray-900 lg:text-lg rounded-lg w-full p-1.5" id="password"
									ref = {passwordRef}
								/>
							</div>
							<button type="submit" 
							...
							<div>
								...
								<Link to="/register" >
								<p className="inline text-sm font-semibold text-blue-500 hover:text-blue-800" id="toRegister"> Sign up</p>
								</Link>
							</div>
						</div>
					</div>
